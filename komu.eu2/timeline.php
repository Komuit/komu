...
<body>
    ...
    <?php include"file-nav.php"; ?>
        ...
        <header class="wrap-title">
            <div class="container">
                <h1 class="page-title">Comunicati</h1>
        ...
        <div class="container">
            <section>
                <h3 class="timeline-title"><span>2014</span></h3>
                <div class="row timeline">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <dl class="dl-horizontal">
                                        <dt><img src="img/home1.jpg" class="img-responsive" alt="Image"></dt>
                                        <dd> <h2 class="home-post-title"><a href="#">Tecnologia a portata di mano</a></h2>
                                            <p>
                                                Migliorare la tua vita è la nostra mission. Anticipiamo i tuoi bisogni, portando sul mercato l'avanguardia tecnologica a
                    ...
                    <div class="col-sm-6 timeline-right">
                        <div class="timeline-event timeline-event-right animated bounceInRight animation-delay-5">
                            <div class="panel panel-primary">
                                <div class="panel-heading">Event with video - 15 January</div>
                                <div class="video">
                        ...
                        <div class="timeline-event timeline-event-right animated bounceInRight animation-delay-11">
                            <div class="panel panel-primary">
                                <div class="panel-heading">Heading Event - 15 January</div>
